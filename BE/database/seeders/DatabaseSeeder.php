...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Img::factory()->create(['url' => 'https://www.ikea.com/ca/en/images/products/salvike…ath-sheet-anthracite__0885425_pe642386_s5.jpg?f=s' => $variation->id]);
        ...
        // Bathroom
        // $prod = Product::factory()->create(['short_description' => '3-piece bathroom set, white', 'long_description' =>'The bathtub is a great way to add a touch of style to your bathroom. It is made of stainless steel and is easy to clean and use.', 'price' => 49.99, 'brand' => 'IKEA', 'material' => 'stainless steel', 'size' => '', 'other' => '', 'id_category' => 8, 'id_subcategory' => 22]);
        //TODO: aggiungere TAG!!
